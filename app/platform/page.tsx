    ...
    <div className="relative flex min-h-screen flex-col bg-white text-zinc-900">
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-6 pt-32 pb-16">
        ...
        <p className="mt-3 text-base leading-relaxed text-zinc-600">
          Orex is the infrastructure layer connecting Isaac Sim and MuJoCo to
          your physical fleet. One workspace, one loop, no glue code.
        </p>
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <span className="text-xs text-zinc-400">
            We&apos;re building with a small group of robotics teams.
          </span>
        </div>
      </main>
      ...
      <footer className="border-t border-zinc-100">
        <div className="mx-auto flex w-full max-w-xl flex-col gap-4 px-6 py-8 text-xs text-zinc-500 sm:flex-row sm:items-start sm:justify-between">
          <div className="font-semibold tracking-tight text-zinc-900">Orex</div>
          <div className="flex flex-col gap-1.5 sm:items-end sm:text-right">
            <span>995 Market St, San Francisco, CA 94103</span>
            <span>6224 Agricultural Rd, Vancouver, BC V6T 1Z1</span>
            <span className="pt-1">© 2026 Orex</span>
          </div>
        </div>
      </footer>
    </div>
